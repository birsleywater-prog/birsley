...
<div class="pb-20">
    <!-- Hero -->
    <div class="bg-gradient-to-br from-brand-900 to-brand-700 py-24 text-white">
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                {#each [["25+", "Years Experience"], ["6+", "Product Sizes"], ["100%", "BIS Certified"], ["24/7", "Working Hours"]] as [num, label]}
                    <div class="aos">
                        <div
                            class="text-4xl font-extrabold font-heading text-brand-600 mb-2"
                        >
                            {num}
                        </div>
    ...
    <section class="py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-14 aos">
                ...
                <h2 class="section-heading">Quality at Every Step</h2>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                {#each [{ icon: "🔬", title: "Triple-Stage Purification", desc: "Our water undergoes RO, UV, and UF treatment to ensure absolute purity and safety." }, { icon: "🏅", title: "BIS IS 14543 Certified", desc: "We comply fully with the Bureau of Indian Standards for packaged drinking water quality." }, { icon: "♻️", title: "Eco-Friendly Packaging", desc: "All our bottles use food-grade recyclable PET material — safe for you and the environment." }] as practice}
                    <div
                        class="aos p-8 rounded-2xl border border-gray-100 hover:shadow-lg transition-all"
                    >
        ...
        <section class="py-20 bg-gray-50/50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {#each [{ icon: "🏅", title: "BIS Certified", subtitle: "IS 14543", desc: "Strictly compliant with the Bureau of Indian Standards for packaged drinking water quality and safety." }, { icon: "🛡️", title: "FSSAI Licensed", subtitle: "Food Safety", desc: "Fully licensed by the Food Safety and Standards Authority of India, ensuring absolute hygiene and health standards." }, { icon: "⚙️", title: "Automated Plant", subtitle: "Technology", desc: "Operating West Bengal's first fully automated plant with 24/7 quality monitoring and zero manual handling." }] as cert, i}
                        <div
                        ...
                        >
                            <div class="flex items-center gap-4 mb-6">
                                <div
                                    class="w-14 h-14 rounded-2xl bg-brand-50 flex items-center justify-center text-3xl group-hover:scale-110 transition-transform duration-300"
                                >
                                    {cert.icon}
                                </div>
                                <div>
                                    <div
                                        class="text-xs font-bold text-brand-500 uppercase tracking-wider"
                                    >
                                        {cert.subtitle}
                                    </div>
                                    <h3
                                        class="font-heading font-extrabold text-gray-900 text-xl"
                                    >
                                        {cert.title}
                                    </h3>
                                </div>
